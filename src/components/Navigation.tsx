    ...
    <>
      ...
      >
        <div className="flex justify-between items-center max-w-full mx-auto">
          ...
          {/* Desktop Navigation - Scrollable for smaller desktop screens */}
          <div className="hidden lg:flex items-center overflow-x-auto scrollbar-hide max-w-full">
            <div className="flex space-x-1 xl:space-x-2 2xl:space-x-3 min-w-max">
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    to={item.path}
                    className={`relative px-3 lg:px-4 xl:px-5 2xl:px-6 py-2.5 lg:py-3 xl:py-3.5 rounded-xl lg:rounded-2xl transition-all duration-500 whitespace-nowrap text-sm lg:text-base xl:text-lg 2xl:text-xl font-poppins font-semibold group overflow-hidden ${
                  ...
                  >
                    ...
                    <div className="absolute inset-0 rounded-xl lg:rounded-2xl bg-gradient-to-r from-blue-500/15 to-purple-500/15 opacity-0 group-hover:opacity-100 transition-all duration-500 scale-95 group-hover:scale-100"></div>
                    
                    {/* 3D depth shadow */}
                    <div className="absolute inset-0 rounded-xl lg:rounded-2xl bg-gradient-to-br from-transparent to-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    
                    {/* Animated underline with gradient */}
                    <div className="absolute bottom-1 lg:bottom-1.5 left-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 group-hover:w-4/5 group-hover:left-[10%] transition-all duration-500 rounded-full shadow-lg shadow-blue-400/50"></div>
                    ...
                    {location.pathname === item.path && (
                      <motion.div
                        ...
                        className="absolute inset-0 rounded-xl lg:rounded-2xl border border-blue-400/30"
                        style={{
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-xl lg:rounded-2xl"></div>
                  </Link>
                </motion.div>
              ))}
            </div>
