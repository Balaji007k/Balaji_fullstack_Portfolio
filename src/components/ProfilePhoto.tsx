...
export const ProfilePhoto = () => {
  return (
    ...
    >
      ...
      <div 
        className="relative w-72 h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-3xl overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <Avatar className="w-48 h-48 lg:w-56 lg:h-56 xl:w-64 xl:h-64 border-4 border-white/20 shadow-2xl">
            <AvatarImage 
