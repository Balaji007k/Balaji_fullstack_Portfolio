...
const Hero = () => {
  return (
    <PageTransition>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 xl:gap-12 items-center w-full max-w-7xl mx-auto py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
